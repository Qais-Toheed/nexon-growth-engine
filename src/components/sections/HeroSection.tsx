...
import { ArrowRight, Calendar, ChevronDown, Zap, Globe, Smartphone, TrendingUp, Bot, Star, Users } from "lucide-react";
...
export function HeroSection() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(160deg, hsl(220 35% 100%) 0%, hsl(218 40% 98%) 50%, hsl(216 50% 96%) 100%)" }}
    >
      {/* Background layers */}
      ...
      {/* Floating metric chips — right edge desktop */}
      {!isMobile && (
        <div className="absolute right-[3%] bottom-[18%] z-[3] hidden xl:flex flex-col gap-3">
          {[
            ...
            <motion.div key={m.label}
              ...
              transition={{ duration: 0.8, delay: 2.2 + i * 0.18 }}
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible">
            ...
            <motion.div variants={fadeUp}>
              <div className="inline-flex items-center gap-2.5 mb-9 pl-1.5 pr-5 py-1.5 rounded-full"
                style={{ background: "hsl(214 100% 50% / 0.07)", border: "1px solid hsl(214 100% 50% / 0.18)" }}>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-14">
              <Button asChild size="lg"
                ...
                style={{
                  ...
                  boxShadow: "0 6px 36px hsl(214 100% 50% / 0.40), inset 0 1px 0 hsl(214 100% 75% / 0.2)",
                }}>
            ...
            <motion.div variants={fadeUp}>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold" style={{ color: "hsl(var(--foreground))" }}>5.0</span>
                  <span className="text-xs" style={{ color: "hsl(var(--muted-foreground))" }}>from 40+ clients</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs" style={{ color: "hsl(var(--muted-foreground))" }}>120+ projects delivered across 15 countries</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
